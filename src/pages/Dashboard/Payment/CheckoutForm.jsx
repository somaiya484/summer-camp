    ...
    return (
        <>
            <form className="w-2/3 m-8" onSubmit={handleSubmit}>
                <CardElement className="bg-slate-200 py-2 rounded"
                    options={{
                        style: {
                            base: {
                                fontSize: '16px',
            ...
            {transactionId && <p className="text-green-600 text-base">Transaction complete with transactionId: {transactionId}</p>}
        </>
    );
};
...
//     return (
//         <>
//             <form className="w-3/4 m-7" onSubmit={handleSubmit}>
//                 <CardElement
//                     options={{
//                         style: {
//                             base: {
