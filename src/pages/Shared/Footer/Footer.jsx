    ...
    return (
        <div>
            <footer className="footer p-10 bg-[#111827] text-white  text-base-content">
                ...
                <div>
                    <span className="footer-title">Bonus</span>
                    <a className="link link-hover">Instrument Lessons</a>
                    <a className="link link-hover">Music Theory</a>
                    <a className="link link-hover">Technique</a>
                    <a className="link link-hover">Sight-Reading</a>
                </div>
                <div>
